<?php
    ...
    <main id="main">
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-6 text-right">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".cadastrar-natureza_despesas-modal-lg">
                  ...
                  //die();
                    foreach ($array_dados as $key => $value) {
                        ...
                        <tr>
                          ...
                          <td><?php echo $value['nome_natureza_despesa'] ?></td>
                          ...
                          <td> 
                            <span class="d-flex">
                              <a href="<?php echo URL ?>View/NaturezaDespesasEditar.php?cod_ibge=<?php echo $value['cod_ibge'] ?>" 
                                class="btn btn-warning mr-1">
                                Editar
                              </a> 
                              <button onclick="apagarDados('<?php echo URL ?>Controller/ControleApagarNaturezaDespesa.php?cod_ibge=<?php echo $value['cod_ibge'] ?>')" class="btn btn-danger">
                                Excluir
                              </button> 
                            </span>
                          </td>
    ...
    <!-- Modal de Cadastro -->
    <div class="modal fade cadastrar-natureza_despesas-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myNaturezaDespesasModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          
          <div class="modal-header">
            <h5 class="modal-title" id="myNaturezaDespesasModalLabel">
              <i class="far fa-plus-square"></i>
          ...
          <form action="../Controller/ControleNaturezaDespesa.php" method="post">
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-12">
                    <label for="recipient-nome_natureza_despesa" class="col-form-label">Nome Município:</label>
                    <input 
                      name="nome_natureza_despesa"
                      placeholder=""
                      type="text" 
                      class="form-control"
                      maxlength="50" 
                      id="recipient-nome_natureza_despesa">
                  </div>
