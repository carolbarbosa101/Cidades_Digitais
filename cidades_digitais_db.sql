...
CREATE TABLE IF NOT EXISTS `cidades_digitais_db`.`cd_itens` (
  ...
  `cod_item` INT NOT NULL,
  `cod_tipo_item` INT NOT NULL,
  `quantidade_previsto` INT NULL DEFAULT 0,
  `quantidade_projeto_executivo` INT NULL DEFAULT 0,
  `quantidade_termo_instalacao` INT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `cidades_digitais_db`.`itens_empenho` (
  ...
  CONSTRAINT `fk_itens_empenho_empenho1`
    ...
    REFERENCES `cidades_digitais_db`.`empenho` (`id_empenho`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `cidades_digitais_db`.`itens_fatura` (
  ...
  `valor` DECIMAL(12,2) NULL DEFAULT 0,
  `quantidade` INT NULL DEFAULT 0,
  PRIMARY KEY (`num_nf`, `cod_ibge`, `id_empenho`, `cod_item`, `cod_tipo_item`),
  INDEX `fk_itens_fatura_fatura1_idx` (`num_nf` ASC, `cod_ibge` ASC),
  INDEX `fk_itens_fatura_itens_empenho1_idx` (`id_empenho` ASC, `cod_item` ASC, `cod_tipo_item` ASC),
  ...
  CONSTRAINT `fk_itens_fatura_itens_empenho1`
    FOREIGN KEY (`id_empenho` , `cod_item` , `cod_tipo_item`)
    REFERENCES `cidades_digitais_db`.`itens_empenho` (`id_empenho` , `cod_item` , `cod_tipo_item`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `cidades_digitais_db`.`itens_otb` (
  ...
  `valor` DECIMAL(12,2) NULL DEFAULT 0,
  `quantidade` INT NULL DEFAULT 0,
  PRIMARY KEY (`cod_otb`, `num_nf`, `cod_ibge`, `id_empenho`, `cod_item`, `tipo_item`),
  INDEX `fk_itens_fatura_has_otb_otb1_idx` (`cod_otb` ASC),
  INDEX `fk_itens_otb_itens_fatura1_idx` (`num_nf` ASC, `cod_ibge` ASC, `id_empenho` ASC, `cod_item` ASC, `tipo_item` ASC),
  ...
  CONSTRAINT `fk_itens_otb_itens_fatura1`
    FOREIGN KEY (`num_nf` , `cod_ibge` , `id_empenho` , `cod_item` , `tipo_item`)
    REFERENCES `cidades_digitais_db`.`itens_fatura` (`num_nf` , `cod_ibge` , `id_empenho` , `cod_item` , `cod_tipo_item`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
BEGIN
insert into itens_empenho (id_empenho, cod_item, cod_tipo_item, cod_previsao_empenho, valor) 
(select empenho.id_empenho, itens_previsao_empenho.cod_item, itens_previsao_empenho.cod_tipo_item, empenho.cod_previsao_empenho, itens_previsao_empenho.valor
from empenho
...
where empenho.id_empenho = (select last_insert_id(new.id_empenho)));
END
$$
